...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2025 at 09:06 PM
...
(1, 'Lan', 'lanngai79@gmail.com', '123'),
(2, 'Fausta', 'f@gmail.com', '456'),
(3, 'Kevin', 'k@gmail.com', '789'),
(4, 'RobertS', 'rsmith@hotmail.com', 'qwe'),
(5, 'Nathan', 'johnbarry21@hotmail.com', 'applejohn52');
...
(1, 3, 'Hello! My name is Kevin. Sadly my mom dislikes cats. We have a dog instead. His name is Enzo and he is 8 years old. ', 'placeholder_pfp.jpg', 20),
(2, 4, 'Hello! I am a cat owner, I hope to find the best products for my kitties!', NULL, 0),
(3, 5, 'Hello! I am a cat owner, I hope to find the best products for my kitties!', NULL, 0);
...
--
ALTER TABLE `login`
  MODIFY `LoginID` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
